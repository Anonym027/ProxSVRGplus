...
file_gd   = RESULTS_DIR / "results_mnist_proxgd.npy"
file_sgd  = RESULTS_DIR / "results_mnist_proxsgd.npy"
file_svrg = RESULTS_DIR / "results_mnist_proxsvrg.npy"
file_plus = RESULTS_DIR / "results_mnist_proxsvrgplus.npy"
...
plt.title("MNIST + NN-PCA: Objective vs SFO")
plt.legend()
plt.grid(True)
...
plt.yscale("log")
plt.title("MNIST + NN-PCA: Grad-map norm^2 vs SFO")
plt.legend()
plt.grid(True)
